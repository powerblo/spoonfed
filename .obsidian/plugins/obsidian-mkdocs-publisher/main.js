  ...
  uploadFolder() {
    return __async(this, null, function* () {
      ...
      if (folder.length > 0) {
        ...
        yield this.uploadText("vault_published.txt", publishedFilesText, "vault_published.txt");
      }
    });
  }
        ...
        callback: () => __async(this, null, function* () {
          ...
          try {
            ...
            if (sharedFiles.length > 0) {
              ...
              const publishedFilesText = publishedFiles.toString();
              yield publish.uploadText("vault_published.txt", publishedFilesText, "vault_published.txt");
