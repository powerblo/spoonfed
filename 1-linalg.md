...
- **Statement** : Every Finite Dimensional has a Basis, with remarks
<br />
...
- **Statement** : Bases have Equal Length I
<br />
...
- **Statement** : Bases have Equal Length II
<br />
...
- **Definition** : Dimension, with remarks
<br />
...
3. Let $U$ be a subspace of a fin-dim vector space $V$, and $T\in\mathcal{L}(U,W)$. Then $T$ can be extended to a linear map on $V$; there exists $S\in\mathcal{L}(V,W)$, $\forall u\in U$, $T(u)=S(u)$.
4. 
